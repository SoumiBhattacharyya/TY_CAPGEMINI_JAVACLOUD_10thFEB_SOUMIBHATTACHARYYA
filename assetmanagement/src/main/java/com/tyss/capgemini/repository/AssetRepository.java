...
import com.tyss.capgemini.beans.AssetBean;
...
public class AssetRepository {
	...
	public List<HashMap<String, Object>> assetTable() {
		...
		AssetBean asset1 = new AssetBean(1, "Dell", "laptop", 100, 50000.0);
		...
		assetHashMap1.put("Price", asset1.getPrice());
		assetsArrayList.add(assetHashMap1);

		HashMap<String, Object> assetHashMap2 = new HashMap<String, Object>();
		AssetBean asset2 = new AssetBean(2, "Hp", "laptop", 50, 30000.0);
		assetHashMap2.put("AssetId", asset2.getAssetId());
		...
		assetHashMap2.put("Price", asset2.getPrice());

		assetsArrayList.add(assetHashMap2);

		HashMap<String, Object> assetHashMap3 = new HashMap<String, Object>();
		AssetBean asset3 = new AssetBean(3, "Lenovo", "laptop", 10, 25000.0);
		...
		AssetBean asset5 = new AssetBean(5, "Acer", "laptop", 11, 27000.0);
